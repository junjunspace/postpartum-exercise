...
const EXERCISES = [
  {
    ...
    practice: {
      ...
      steps: [
        ...
        { cue: '脚尖向上勾起', phase: '背屈 · 保持 3 秒', dur: 3, hint: '每个动作 3 秒', audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e01/02.m4a' },
        { cue: '向下绷直', phase: '跖屈 · 保持 3 秒', dur: 3, hint: '每个动作 3 秒', audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e01/03.m4a' },
  ...
  },
  {
    ...
    practice: {
      ...
      steps: [
        ...
        { cue: '鼻子缓慢吸气……', phase: '吸气 · 4秒', dur: 4, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e02/02.m4a' },
        { cue: '缓慢呼出……', phase: '呼气 · 6秒', dur: 6, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e02/03.m4a' }
      ],
  ...
  },
  {
    ...
    practice: {
      ...
      steps: [
        ...
        { cue: '缓慢收缩……', phase: '收缩 · 5秒', dur: 5, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e03/02.m4a' },
        { cue: '完全放松盆底——不要用力', phase: '放松 · 5秒', dur: 5, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e03/03.m4a' },
  ...
  },
  {
    ...
    practice: {
      ...
      steps: [
        ...
        { cue: '保持内收，正常呼吸', phase: '维持 10秒', dur: 10, hint: '保持自然呼吸，不要憋气', audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e04/03.m4a' },
        { cue: '放松', phase: '放松 3秒', dur: 3, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e04/04.m4a' }
      ],
  ...
  },
  {
    ...
    practice: {
      ...
      steps: [
        ...
        { cue: '停顿', phase: '保持 2秒', dur: 2, audio: 'cloud://cloud1-d1gp0f2s312426955.636c-cloud1-d1gp0f2s312426955-1420052148/audio/e06/04.m4a' },
